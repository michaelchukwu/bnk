                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <div class="form-group">
                                    <input name="registration" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input name="module[branch_create_user]" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                                        @if ($modules && @$modules->branch_create_user) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <div class="form-group">
                                    <input name="force_ssl" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <div class="form-group">
                                    <input name="agree" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <div class="form-group">
                                    <input name="secure_password" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <div class="form-group">
                                    <input name="kv" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <div class="form-group">
                                    <input name="ev" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <div class="form-group">
                                    <input name="en" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <div class="form-group">
                                    <input name="sv" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <div class="form-group">
                                    <input name="sn" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="multi_language"
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input name="module[deposit]" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                                        @if ($modules && $modules->deposit) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input name="module[withdraw]" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                                        @if ($modules && $modules->withdraw) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input name="module[fdr]" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                                        @if ($modules && $modules->fdr) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input name="module[dps]" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                                        @if ($modules && $modules->dps) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input name="module[loan]" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                                        @if ($modules && $modules->loan) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input name="module[own_bank]" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                                        @if ($modules && $modules->own_bank) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input name="module[other_bank]" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                                        @if ($modules && $modules->other_bank) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input name="module[wire_transfer]" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                                        @if ($modules && @$modules->wire_transfer) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input name="module[otp_email]" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                                        @if ($modules && $modules->otp_email) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input name="module[otp_sms]" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                                        @if ($modules && $modules->otp_sms) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-group">
                                    <input name="module[referral_system]" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                                        @if ($modules && @$modules->referral_system) checked @endif>
                                </div>
                            </li>
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                ...
                                <div class="form-group">
                                    <input name="pn" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox"
                                        @if ($general->pn) checked @endif>
                                </div>
                            </li>
                        </ul>
                    </div>
