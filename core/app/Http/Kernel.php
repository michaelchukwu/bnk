...
class Kernel extends HttpKernel {
    ...
    protected $routeMiddleware = [
        ...
        'branch.staff' => \App\Http\Middleware\RedirectIfNotBranchStaff::class,
        'branch.staff.guest' => \App\Http\Middleware\RedirectIfBranchStaff::class,
        'checkAccountOfficer' => \App\Http\Middleware\CheckAccountOfficer::class,
