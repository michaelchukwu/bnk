                                    ...
                                    @forelse($allFdr as $fdr)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <small
                                                    class="d-block text--base">{{ diffForHumans($fdr->locked_date, 'd M, Y') }}</small>
                                            </td>
                                            ...
                                            <td>
                                                <div class="btn--group">
                                                    <button type="button" data-id="{{ $fdr->id }}"
                                                        class="btn btn-outline--base btn-sm closeBtn"
                                                        @disabled(($fdr->locked_date->endOfDay() >= now() && $fdr->status == 1) || $fdr->status == 2)>
